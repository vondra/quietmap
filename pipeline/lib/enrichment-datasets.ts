...
export const DATASETS: Dataset[] = [
  ...
  // ── Roads: national (OSM-only) ──
  {
    ...
    name: 'DNV TMDA 2017-18 traffic observations',
    year: 2018,
    license: 'public-data',
  ...
  },
  {
    id: 9870,
    layer: 'roads',
    key: 'ar-road-classification-fallback',
    name: 'Argentina DNV road-classification traffic fallback',
    year: 2018,
    license: 'public-data',
    url: 'https://ide.transporte.gob.ar/geoserver/observ/ows',
    priority: 80,
  ...
  },
  {
    ...
    name: 'MOP Plan Nacional de Censos TMDA observations',
    year: 2025,
    license: 'public-data',
  ...
  },
  {
    id: 9871,
    layer: 'roads',
    key: 'cl-road-classification-fallback',
    name: 'Chile MOP Vialidad road-classification traffic fallback',
    year: 2025,
    license: 'public-data',
    url: 'https://rest-sit.mop.gob.cl/',
    priority: 80,
  ...
  },
  {
    ...
    name: 'INVIAS TPDS_NUBE TPDA observations',
    year: 2024,
    license: 'public-data',
  ...
  },
  {
    id: 9872,
    layer: 'roads',
    key: 'co-road-classification-fallback',
    name: 'Colombia INVIAS road-classification traffic fallback',
    year: 2024,
    license: 'public-data',
    url: 'https://services6.arcgis.com/kyerLIHvrND0OSya/',
    priority: 80,
  ...
  },
  {
    ...
    name: 'Bina Marga GIS (PUPR) — regional LHRT observations',
    year: 2024,
    license: 'public-data',
  ...
  },
  {
    id: 9873,
    layer: 'roads',
    key: 'id-road-classification-fallback',
    name: 'Indonesia Bina Marga road-classification traffic fallback',
    year: 2024,
    license: 'public-data',
    url: 'https://gisportal.binamarga.pu.go.id/',
    priority: 80,
  ...
  },
  {
    ...
    name: 'MTC Provías dIMD traffic observations (ArcGIS mirror)',
    year: 2024,
    license: 'public-data',
  ...
  },
  {
    id: 9874,
    layer: 'roads',
    key: 'pe-road-classification-fallback',
    name: 'Peru MTC Red Vial road-classification traffic fallback',
    year: 2024,
    license: 'public-data',
    url: 'https://services6.arcgis.com/G8JFnqCHKQ9vb8YW/',
    priority: 80,
  ...
  },
  {
    ...
    name: 'Saudi Ministry of Transport traffic-count stations',
    year: 2024,
    license: 'open-data',
  ...
  },
  {
    id: 9875,
    layer: 'roads',
    key: 'sa-road-classification-fallback',
    name: 'Saudi Riyadh PMS and road-atlas traffic fallback',
    year: 2024,
    license: 'open-data',
    url: 'https://mot.gov.sa/en/open-data',
    priority: 80,
  ...
  },
  {
    ...
    name: 'Thailand DRR Rural Roads AADT observations (MOT CKAN mirror)',
    year: 2024,
    license: 'public-data',
  ...
  },
  {
    id: 9876,
    layer: 'roads',
    key: 'th-road-classification-fallback',
    name: 'Thailand DOH corridor-class traffic fallback',
    year: 2024,
    license: 'public-data',
    url: 'https://datagov.mot.go.th/',
    priority: 80,
  ...
  },
  {
    ...
    priority: 80,
    measurement: 'proxy',
    roadCoverage: [0, 1, 2, 3, 4, 5, 10, 11, 12],
  },
  {
    id: 9392, // JP = 392
    layer: 'roads',
  ...
  // ── Railways: national (OSM-only) ──
  {
    ...
    name: 'Dubai RTA GTFS (2025 archive; current publisher unavailable)',
    year: 2025,
    license: 'open-data',
  ...
  },
  {
    ...
    name: 'Buenos Aires Subte GTFS (2019 archive; current publisher unavailable)',
    year: 2019,
    license: 'public-data',
  ...
  },
  {
    ...
    name: 'Italian regional rail GTFS (current feeds + Ferrotramviaria 2025 archive)',
    year: 2025,
    license: 'CC-BY-4.0',
  ...
  // structure rows carry `height_source`, not `source_id` — this entry
  // documents the survey raster's license/URL/rank for docs + attribution
  // (height_source 3 = regional survey).
  {
    id: 9867,
    layer: 'buildings',
