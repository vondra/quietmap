 ...
 * `vehicle_trips_per_occupied_dwelling` from country-fleet.generated.ts once
...
/** Exactly one of `dwellings`/`trips` is non-zero. */
...
/**
 * Building geometry → {dwellings, trips} (exactly one non-zero, floats).
