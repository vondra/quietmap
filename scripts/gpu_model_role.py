...
GENERATED_DEFINE_NAMES = frozenset(
    {
        ...
        "DIFFRACTION_SLOPE_D",
        "LOWEST_SOURCE_TANGENT_ANGLE_MARGIN_RAD_D",
        "LOWEST_SOURCE_TANGENT_BLOCK_PX",
        "LOWEST_SOURCE_TANGENT_GROUPS",
        "LOWEST_SOURCE_TANGENT_MARGIN_ABS_D",
        "LOWEST_SOURCE_TANGENT_MARGIN_REL_D",
        "LOWEST_SOURCE_TANGENT_RANGE_MARGIN_M_D",
        "M_LAT",
        "NPD_NC",
