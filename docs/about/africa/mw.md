---
title: Malawi
intro: Roads use the world defaults; the freight-only rail network carries the world rail default.
...
Train counts: no timetable. Mapped active railways use the [world railway defaults](/about/methodology). The network carries freight, mainly coal trains to Nacala, at far fewer than 100 trains per day; rail noise is overstated.
