---
title: Guatemala
intro: Roads use OSM class defaults scaled by 1.298. No operating railway. Power plants from Global Energy Monitor.
map: { center: [-90.5, 15.5], zoom: 7 }
---

## Roads

No open traffic counts; roads use OSM class defaults. Motorways, trunks, primaries and their ramps are scaled by 1.298 (registered vehicles per road kilometre relative to Germany).
