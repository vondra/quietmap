...
No timetable is loaded: Romania publishes its timetable in its own XML format, which is not read yet. Class defaults apply: 80 passenger and 85 freight trains per day on main lines, 30 and 5 on branch lines, 120 trams on tram tracks.
