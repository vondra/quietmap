---
title: quietmap.org
intro: Find your quiet place. A world atlas of environmental noise — roads, railways, aircraft, ships, and industry.
...
1. **Sources emit noise.** Roads, trains, planes, ships, factories and buildings — each modelled from real data: traffic counts, timetables, a year of flight tracks, ship positions, registries.
2. **Sound travels and fades.** Hills block it, buildings screen it, forests absorb it — simulated with ISO 9613-2 physics.
3. **You see the result** on a raster of roughly 6 meters, from pale (quiet) through yellow and orange to deep purple (80+ dB).
...
<p>
<img src="popup-source-detail.png" alt="Noise sources — the M4 near London with its sound path breakdown" style="display:inline-block;width:300px;max-width:48%;vertical-align:top;margin:0 12px 0 0">
<img src="popup-segment.png" alt="Segments — a Berlin railway segment with the terrain profile" style="display:inline-block;width:300px;max-width:48%;vertical-align:top;margin:0">
</p>
...
time. The current generation dates from September 2026, with flights from 2 September 2025
to 1 September 2026.
...
A Web-Mercator raster at zoom 13 (512-pixel tiles, about 6 m per pixel at 50°N and 10 m at the equator) — fine enough to tell the street side of a building from its garden side. Coarser levels of the same paint serve the zoomed-out views. Levels are computed 4 m above ground, as the END prescribes.
