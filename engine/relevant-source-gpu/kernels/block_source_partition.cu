...
__global__ void evaluate_corner_source_pairs_kernel(
    ...
    const float* __restrict__ corner_pixel_floor_m,
    ...
    scene.pixel_floor_m = corner_pixel_floor_m[corner];
...
__global__ void paint_relevant_sources_kernel(
    DeviceScenePointers scene,
    const float* __restrict__ receiver_pixel_floor_m,
    ...
    scene.pixel_floor_m = receiver_pixel_floor_m[pixel];
...
extern "C" int relevant_source_cuda_evaluate_corners(
    ...
    const float* corner_pixel_floor_m,
...
extern "C" int relevant_source_cuda_paint_tile(
    const DeviceScenePointers* scene,
    const float* receiver_pixel_floor_m,
