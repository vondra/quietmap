...
pub const SOURCES: &[Source] = &[
    ...
    Source {
        ...
        license: Some("Public Domain (US DOT)"),
        url: Some("https://data.transportation.gov/Railroads/Crossing-Inventory-Data-Form-71-Current/m2f8-22s6"),
        year: Some(2026),
    },
    Source {
        id: 112,
        ...
        license: Some("OGL-Canada (attribution required)"),
        url: Some("https://open.canada.ca/data/en/dataset/d0f54727-6c0b-4e5a-aa04-ea1463cf9f4c"),
        year: Some(2023),
    },
    Source {
        id: 200,
    ...
    Source {
        ...
        license: Some("public-data"),
        url: Some("https://buenosaires.gob.ar/sites/gcaba/files/subte_gtfs.zip"),
        year: Some(2019),
    },
    Source {
        id: 2005,
    ...
    Source {
        ...
        url: Some("https://www.nationaalgeoregister.nl/geonetwork/srv/api/records/93e99016-9b53-45d6-8b3c-fc9bf8086256"),
        year: Some(2024),
    },
    Source {
        id: 9566,
    ...
    Source {
        ...
        license: Some("CC-BY-4.0"),
        url: Some("https://podatki.gov.si/dataset/pldp-karte-prometnih-obremenitev"),
        year: Some(2024),
    },
    Source {
        id: 9729,
    ...
    Source {
        ...
        license: Some("OGD Switzerland (open use, attribution)"),
        url: Some("https://www.astra.admin.ch/de/schweizerische-automatische-strassenverkehrszaehlung-sasvz"),
        year: Some(2024),
    },
    Source {
        id: 9792,
